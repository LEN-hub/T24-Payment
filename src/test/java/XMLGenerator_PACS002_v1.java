...
public class XMLGenerator_PACS002_v1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<Map<String, String>> values = readTestDataFromExcel("E:\\TEST\\automation\\T24-payment\\import_xml_files\\TestData_PACS002_v1.xlsx");
            ...
            for (Map<String, String> data : values) {
                ...
                Document doc = builder.parse(new File("E:\\TEST\\automation\\T24-payment\\import_xml_files\\001PACS002.xml"));
                ...
                String fileName = "output_xml_files/" + currentDate + fileCounter + "PACS002.xml";
                fileCounter++;
