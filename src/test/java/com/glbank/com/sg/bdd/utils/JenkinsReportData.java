...
//creating a constructor of file class and parsing an XML file
            File file = new File( systemPath + "/Testcase/target/failsafe-reports/failsafe-summary.xml");
...
// nodeList is not iterable, so we are using for loop
    ...
    public static void writeFile(String path) throws Exception{
        ...
        String allPath = systemPath + "/Testcase/src/test/resources/testData/autopay/" + path + ".txt";
    ...
    public static String FileInput3(String path) {
        path = systemPath + "/Testcase/src/test/resources/testData/autopay/" + path + ".txt";
