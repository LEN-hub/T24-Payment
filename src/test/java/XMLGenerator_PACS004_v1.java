...
public class XMLGenerator_PACS004_v1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<Map<String, String>> values = readTestDataFromExcel("E:\\TEST\\automation\\T24-payment\\import_xml_files\\TestData_PACS004_v1.xlsx");
            ...
            for (Map<String, String> data : values) {
                ...
                Document doc = builder.parse(new File("E:\\TEST\\automation\\T24-payment\\import_xml_files\\001PACS004.xml"));
                ...
                String fileName = "output_xml_files/" + currentDate + fileCounter + "PACS004.xml";
                fileCounter++;
    ...
    private static void modifyXml(Element element, Map<String, String> values) {
        ...
        modifyNodeList(element.getElementsByTagName("SenderReference"), values);
        modifyNodeList(element.getElementsByTagName("DN"), element.getElementsByTagName("Sender"), values);
        modifyNodeList(element.getElementsByTagName("X1"), element.getElementsByTagName("Sender"), values);
        modifyNodeList(element.getElementsByTagName("UserReference"), values);
        modifyNodeList(element.getElementsByTagName("BICFI"), element.getElementsByTagName("Fr"), values);
        ...
        modifyNodeList(element.getElementsByTagName("RtrId"), values);
        modifyNodeList(element.getElementsByTagName("OrgnlMsgId"), values);
        modifyNodeList(element.getElementsByTagName("OrgnlCreDtTm"), values);
        modifyNodeList(element.getElementsByTagName("OrgnlInstrId"), values);
        modifyNodeList(element.getElementsByTagName("OrgnlUETR"), values);
        modifyNodeList(element.getElementsByTagName("OrgnlIntrBkSttlmAmt"), values);
        modifyNodeList(element.getElementsByTagName("OrgnlIntrBkSttlmDt"), values);
        modifyNodeList(element.getElementsByTagName("RtrdIntrBkSttlmAmt"), values);
        modifyNodeList(element.getElementsByTagName("IntrBkSttlmDt"), values);
        modifyNodeList(element.getElementsByTagName("RtrdInstdAmt"), values);
        modifyNodeList(element.getElementsByTagName("ChrgBr"), values);
        modifyNodeList(element.getElementsByTagName("Amt"), values);
        modifyNodeList(element.getElementsByTagName("BICFI"), element.getElementsByTagName("Agt"), values);
        modifyNodeList(element.getElementsByTagName("BICFI"), element.getElementsByTagName("InstgAgt"), values);
        modifyNodeList(element.getElementsByTagName("AnyBIC"), values);
        modifyNodeList(element.getElementsByTagName("BICFI"), element.getElementsByTagName("DbtrAgt"), values);
