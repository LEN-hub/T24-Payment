...
public class XMLGenerator_SGMEPS_PACS008_v1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<Map<String, String>> values = readTestDataFromExcel("E:\\TEST\\automation\\T24-payment\\import_xml_files\\TestData_MEPSPACS008_v1.xlsx");
            ...
            for (Map<String, String> data : values) {
                ...
                Document doc = builder.parse(new File("E:\\TEST\\automation\\T24-payment\\import_xml_files\\001MEPSPACS008.xml"));
                ...
                String fileName = "output_xml_files/" + currentDate + fileCounter + "MEPSPACS008.xml";
                fileCounter++;
    ...
    private static void modifyXml(Element element, Map<String, String> values) {
        ...
        modifyNodeList(element.getElementsByTagName("Saa:CreationTime"), values);
        ...
        modifyNodeList(element.getElementsByTagName("InstdAmt"), values);
        ...
        //modifyNodeList(element.getElementsByTagName("Id"), element.getElementsByTagName("Othr"), values);
        ...
        if (cdtrAcctNode != null && cdtrAcctNode.getNodeType() == Node.ELEMENT_NODE) {
            ...
            if (idNode != null && idNode.getNodeType() == Node.ELEMENT_NODE) {
                ...
                idNode.setTextContent(values.get("Id"));
            }
        }
    }
