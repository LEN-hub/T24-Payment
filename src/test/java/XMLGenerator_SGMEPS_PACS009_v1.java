...
public class XMLGenerator_SGMEPS_PACS009_v1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<Map<String, String>> values = readTestDataFromExcel("E:\\TEST\\automation\\T24-payment\\import_xml_files\\TestData_MEPSPACS009_v1.xlsx");
            ...
            for (Map<String, String> data : values) {
                ...
                Document doc = builder.parse(new File("E:\\TEST\\automation\\T24-payment\\import_xml_files\\001MEPSPACS009.xml"));
                ...
                String fileName = "output_xml_files/" + currentDate + fileCounter + "MEPSPACS009.xml";
                fileCounter++;
    ...
    private static void modifyXml(Element element, Map<String, String> values) {
        ...
        modifyNodeList(element.getElementsByTagName("BICFI"), element.getElementsByTagName("Dbtr"), values);
