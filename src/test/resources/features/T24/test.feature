...
Feature: Auto_Test
  ...
  @Payment_Loan_Disbursement_External_USD-USD_Amount>threshold1
  Scenario:Regression-Outgoing- T24-LOAN Disbursement-0001-1，4
    Given Use "T24-automation-UAT-login" to login to T24 environment
    When I click Loan Transactions Button
  ...
  Scenario:Regression-Outgoing- T24-LOAN Disbursement-0002-1，4
    Given Use "T24-automation-UAT-login" to login to T24 environment
    When I click Loan Transactions Button
    ...
    When I input information on the Loan Disbursement SGMEPS Page
      ...
      |18500003189         |SGD           |SGD             |260003        |345665                |CITISGS0            |lei             |
