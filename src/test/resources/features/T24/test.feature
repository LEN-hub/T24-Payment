...
#      |Bic is DBS USD-USD|Bic is DBS USD-USD|
  ...
  @Regression-Outgoing-Channel0006-After
  Scenario:Regression-Outgoing-Channel0006-After
    Given logon "INB-automation-SIT-login" in SIT environment and bypass Vkey
    When I click on overseas transfer payment and select the account
...
#    When I click on the receiving bank drop down box
  ...
  @Regression-Outgoing-Channel0007-After
  Scenario:Regression-Outgoing-Channel0007-After
