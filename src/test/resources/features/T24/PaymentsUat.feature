...
#本人互转
  ...
  Scenario:Transfer time within the line is selected every Monday (SGD->SGD)
    ...
    When I fill in the transfer information of domestic transfer bank
      ...
      |BANK OF CHINA LIMITED  |11010001426           |Business Expenses   |1101 0001 256 |MEPS        |VPA        |UEN123321001  |
    ...
    When I jump to a newly opened page on Mx Message
      |windows Title                            |WordPath                  |
      |Pending and Processed Payments - UAT GLDB|Local Fund Payment SGD-SGD|
...
#
#
#  @PaymentUatFastPayNow
#    #境内转账-跨行转账时间选择每周一(SGD->SGD)
#  Scenario:Fast/PayNow
#    Given logon "netSilverEnv_Kevin_Payment" on enterprise net silver
#    When I fill in the transfer information of domestic transfer bank
#      |Payee's Bank           |Payee's Account Number|Purpose of Transfer |From Account  |Payment Type|PayNow Type|PayNow Content|
...
#    When I check the deduction amount on the Find Account page On overseas transfer Payment
#      |windows Title            |WordPath                     |
#      |AA Arrangement - SIT GLDB|Bic is Bank of China USD-USD |
#
#      #境外转账
#  @PaymentUat11
...
#    When I check the deduction amount on the Find Account page On overseas transfer Payment
#      |windows Title            |WordPath                     |
#      |AA Arrangement - SIT GLDB|Bic is Bank of China SGD-USD |
#
#
#  @PaymentUat12
...
#    When I check the deduction amount on the Find Account page On overseas transfer Payment
#      |windows Title            |WordPath                     |
#      |AA Arrangement - SIT GLDB|Bic is Bank of China USD-SGD |
#
#  @PaymentUat13
...
#    When I check the deduction amount on the Find Account page On overseas transfer Payment
#      |windows Title            |WordPath                     |
#      |AA Arrangement - SIT GLDB|Bic is Bank of China SGD-SGD |
