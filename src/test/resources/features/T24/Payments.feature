...
#    Then I will compare all the data on FX Payment
    ...
    |search content|user Authorize                 |user view             |
    |FOREX         |netSilverEnv_Kevin_T24_SIT_Auth|netSilverEnv_Kevin_SIT|
...
@LocalPaymentTestSGDToSGD
  ...
  Scenario:Transfer time within the line is selected every Monday (SGD->SGD)
    ...
    When I fill in the transfer information of domestic transfer bank
      ...
      |Green Link Digital Bank Pte. Ltd|TSC1643346550706|678321687312          |Business Expenses   |1101 0000 438 |
