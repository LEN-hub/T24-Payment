@Payment_SameCurrency_Single_BEN_SGD_SGD
Feature: Payment Same Currency and Single Automation Test Case Execution SGD-SGD

  @PaymentSIT_SingleCurrency_SameCurrency_BEN_SGD_SGD=250k
  Scenario:Overseas transfer in the same currency and single BEN Automation Test Case Execution SGD-SGD = 250k
