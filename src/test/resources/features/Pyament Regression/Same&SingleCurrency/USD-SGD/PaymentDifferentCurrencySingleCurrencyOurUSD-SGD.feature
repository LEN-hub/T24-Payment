@Payment_DifferentCurrency_Single_OUR_USD_SGD
Feature: Payment Different Currency and Single Our Automation Test Case Execution USD_SGD

  @PaymentSIT_SingleCurrency_DifferentCurrency_OUR_USD_SGD<250k
  Scenario:Overseas transfer in the Different currency and Single currency OUR Automation Test Case Execution USD-SGD < 250k
