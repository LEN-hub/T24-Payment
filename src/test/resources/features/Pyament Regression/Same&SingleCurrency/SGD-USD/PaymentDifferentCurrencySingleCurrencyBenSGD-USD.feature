@Payment_DifferentCurrency_Single_BEN_SGD_USD
Feature: Payment Different Currency and Single Ben Automation Test Case Execution SGD-USD

  @PaymentSIT_SingleCurrency_DifferentCurrency_BEN_SGD_USD=250k
  Scenario:Overseas transfer in the Different currency and Single currency BEN Automation Test Case Execution SGD-USD = 250k
