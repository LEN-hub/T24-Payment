...
Feature: Payment Same Currency and Multi Automation Test Case Execution USD-USD
  ...
  @PaymentSIT_MultiCurrency_SameCurrency_OUR_USD_USD<250k
  Scenario:Overseas transfer in the same currency and Multi currency OUR Automation Test Case Execution USD-USD < 250k
