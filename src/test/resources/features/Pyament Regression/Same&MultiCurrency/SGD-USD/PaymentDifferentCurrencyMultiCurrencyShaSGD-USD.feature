@Payment_DifferentCurrency_Multi_SHA_SGD_USD
Feature: Payment Different Currency and Multi Sha Automation Test Case Execution SGD-USD

  @PaymentSIT_MultiCurrency_DifferentCurrency_SHA_SGD_USD=250k
  Scenario:Overseas transfer in the Different currency and Multi currency SHA Automation Test Case Execution SGD-USD = 250k
