@Payment_DifferentCurrency_Multi_OUR_SGD_USD
Feature: Payment Different Currency and Multi Our Automation Test Case Execution SGD-USD

  @PaymentSIT_MultiCurrency_DifferentCurrency_OUR_SGD_USD=250k
  Scenario:Overseas transfer in the Different currency and Multi currency OUR Automation Test Case Execution SGD-USD = 250k
