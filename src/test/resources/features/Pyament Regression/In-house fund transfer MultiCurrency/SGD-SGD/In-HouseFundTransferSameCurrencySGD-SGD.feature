@Payment_In_House_Fund_Transfer_Same_Currency_MCY_SGD-SGD
Feature: Payment In House Fund Transfer and MCY Automation Test Case Execution SGD-SGD

  @PaymentSIT_In_House_MCY_Currency_SGD_SGD
  Scenario:In house fund transfer same & MCY currency SGD-SGD
